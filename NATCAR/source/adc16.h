...
//char cirbuf[500];
int counter1;
int pp_toggle; //ping pong toggle
int done;
int Total;
int min;
int max;

//Added ping-pong buffering
char ping1[128];
char pong1[128];
char ping2[128];
char pong2[128];
...
int TOFCount;
int input_capture[4];
int input_capture_avg;
int avg;
int avg_flag;
int ModNum;
int speed_sensor_motor;
//added for PID
int calculated_dmiddles_flag ; 
int evaluated_middles_counter ; 
int currentmiddle; 
int oldmiddle; 
int currentmiddle2;
int oldmiddle2;
...
int d_control_done;
int SLOWDOWN;
int SLOWDOWN_COUNTER;
int STOP;
int STOP_FLAG;
int STOP_COUNTER;
int BRAKE_TURN; //0 LEFT, 1 RIGHT
//int pnflag = 0;
